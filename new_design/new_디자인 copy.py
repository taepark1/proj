...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.show_answer.stateChanged.connect(self.on_show_answer_changed)

    def on_previous_button_clicked(self):
        print("이전 문제 버튼이 클릭되었습니다.")
        # 여기에 실제 문제를 변경하는 로직을 추가합니다.

    def on_next_button_clicked(self):
        print("다음 문제 버튼이 클릭되었습니다.")
        # 여기에 실제 문제를 변경하는 로직을 추가합니다.

    def on_show_answer_changed(self, state):
        if state == QCheckBox.Checked:
            print("정답 보기가 선택되었습니다.")
            # 여기에 정답을 보여주는 로직을 추가합니다.
        else:
            print("정답 보기 선택이 해제되었습니다.")
            # 정답 숨기기 로직을 구현합니다.
    # setupUi
