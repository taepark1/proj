...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.problem_names = ["  Q : 만나다", "  Q : 존경하다", "  Q : 집", "  Q : 책", "  Q : 맥주"]
        self.weight_names = ["meet", "house", "book", "respect", "ob"]
        self.image_names_index = 0
        self.base_image_path = "/home/jisopark/to_study/prototype/{}.png" #수정필요
        self.base_weight_path = "C:\\git\\main\\proj\\proj\\{}.pt" #수정필요
        self.show_index = 0

        font_path = "/home/jisopark/Documents/downloaded_fonts/SBAggro Bold.ttf"
        ...
        # 이미지 크기와 연관된것인가?
        self.answer_carasel.setGeometry(QRect(44, 28, 250, 241))
    ...
    #----
        ...
        self.problem_group.setFont(custom_font)
