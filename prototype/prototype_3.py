...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        script_dir = os.path.dirname(os.path.abspath(__file__))
        font_path = os.path.join(script_dir, "fonts","MangoDdobakR.ttf")
        ...
        font_answer_group.setFamilies("MangoDdobakR")
    ...
    #----
        ...
        font_problem_group.setFamily("MangoDdobakR")
        ...
        font_problem_word.setFamily("MangoDdobakR")
        custom_font.setPointSize(28)
        ...
        self.show_answer.setGeometry(QRect(300, 320, 88, 20))
...
#            self.answer_carasel.setPixmap(pixmap1)
    ...
    def retranslateUi(self, Dialog):
        ...
        answerbutton_font = QFont()
        answerbutton_font.setFamily("MangoDdobakR")
        answerbutton_font.setPointSize(13)
        self.show_answer.setFont(answerbutton_font)
        ...
        button_font = QFont()
        button_font.setFamily("MangoDdobakR")
